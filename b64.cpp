...
int B64::B64FromLookup(char tmp_input){
    ...
    if (temp_input >= 'A' and temp_input <= 'Z') return temp_input - 'A'; //0-25
    if (temp_input >= 'a' and temp_input <= 'z') return temp_input - 71; //26-51
    if (temp_input >= '0' and temp_input <= '9') return temp_input + 4; //52-61
